...
!Miss		= #$29			; If you've changed list.txt and plan on using the original SMW songs
!GameOver	= #$2A			; change these constants to whatever they are in list.txt
!BossClear	= #$2B			; For example, if you changed the "Stage Clear" music to be number 9,
!StageClear	= #$2C			; Then you'd change "!StageClear = #$04" to "!StageClear = #$09".
!Starman	= #$2D
!PSwitch	= #$2E
!Keyhole	= #$2F
!IrisOut	= #$30
